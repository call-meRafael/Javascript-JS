...
const {
  engenharia: { chefe: diretorEngenaria = "Desconhecido" },
  pesquisa: { chefe: diretorPesquisa = "Desconhecido" },
} = controleDeMissoes.setores;
...
const navesEngenharia = Object.entries(
  controleDeMissoes.setores.engenharia.naves,
);
